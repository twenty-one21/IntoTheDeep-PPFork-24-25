...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.18,0,0.012,0);
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.0070,0,0.00015,0.6,0);
